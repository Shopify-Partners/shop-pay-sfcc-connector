...
program
    .command('code:zip')
    .option('-r, --release <release-name>', 'Describes the name of the code deployment from to generate an archive. This name shows in Business Manager Code Deployments', `localBuild-${timestamp}`)
